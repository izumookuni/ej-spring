...
import cc.domovoi.spring.entity.extension.ExportEntityInterface;
...
public interface ExportControllerInterface<C, E extends ExportEntityInterface<C>> extends GeneralRetrieveControllerInterface<E> {
        ...
        try(Workbook wb = new XSSFWorkbook(); ServletOutputStream outputStream = response.getOutputStream()) {
            ...
            String fileName = (eList.size() == 1 ?
                    ...
                    (entity.exportTitle().get() != null ?
                            ...
                            "Untitled-" + LocalDateTime.now().format(ObjectMappers.dateTimeFormatter)
                    )) + ".xlsx";
